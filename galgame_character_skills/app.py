...
def create_app(app_dependencies=None, task_runtime=None):
    ...
    def _generate_skills_folder(payload):
        return generate_skills_folder_result(data=payload, runtime=runtime)

    def _generate_character_card(payload):
        return generate_character_card_result(data=payload, runtime=runtime)

    def _summarize(payload):
        return summarize_result(data=payload, runtime=runtime)
    ...
    def summarize():
        return _run_json_with_body(summarize_result, runtime)
    ...
    def get_checkpoint(checkpoint_id):
        return _run_json(get_checkpoint_result, runtime.checkpoint_gateway, checkpoint_id)

    @app.route("/api/checkpoints/<checkpoint_id>", methods=["DELETE"])
    def delete_checkpoint(checkpoint_id):
        return _run_json(delete_checkpoint_result, runtime.checkpoint_gateway, checkpoint_id)

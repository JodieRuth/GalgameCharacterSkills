...
def build_initial_character_card_fields(role_name, creator, vndb_data, lorebook_entries):
    base_name = role_name
...
def apply_checkpoint_fields(fields_data, ckpt_fields_data):
...
def build_character_card_messages(is_resuming, ckpt_messages, ckpt_iteration_count, system_prompt, role_name):
    if is_resuming:
...
def build_character_card_success_result(output_path, fields_data, result):
    return {
        "success": True,
